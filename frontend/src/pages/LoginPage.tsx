    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-nn-pale-sky to-nn-mist px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 rounded-xl bg-nn-pale-sky px-4 py-3 text-center text-xs text-nn-navy-light">
            <strong className="text-nn-deep-blue">Demo mode:</strong> No credentials needed.{' '}
            <Link to="/dashboard" className="font-medium text-nn-deep-blue hover:underline">
              Open the demo →
            </Link>
          </div>
        </div>
